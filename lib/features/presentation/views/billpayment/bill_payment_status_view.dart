...
class BillPaymentStatusView extends BaseView {
  @override
  _BillPaymentStatusViewState createState() => _BillPaymentStatusViewState();
}

class _BillPaymentStatusViewState extends BaseViewState<BillPaymentStatusView> {
                    ...
                    children: [
                      CDBBorderGradientButton(
                        ...
                        text: isPaymentSuccess
                            ? AppString.saveBiller.localize(context)
