...
class EditAccountNicknameView extends BaseView {
  final AccountEntity accountEntity;

  EditAccountNicknameView({this.accountEntity});

  @override
  _EditAccountNicknameViewState createState() => _EditAccountNicknameViewState();
}

class _EditAccountNicknameViewState extends BaseViewState<EditAccountNicknameView> {
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      CdbCustomTextField(
                        key: const Key("keyAccountNickName"),
                        labelText: AppString.labelAccountNickName.localize(context),
                        initialValue: widget.accountEntity.nickName,
                        onChange: (value) {
                          setState(() {
                            widget.accountEntity.nickName = value;
                          });
                        },
                      ),
                      ...
                      if (widget.accountEntity.isCDBAccount) Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          const SizedBox(height: 20),
                          Text(
                            AppString.labelTotalAvailableBalance.localize(context),
                            style: AppStyling.normal400Size14
                                .copyWith(color: AppColors.textTitleColor),
                          ),
                          Padding(
                  ...
                  child: Column(
                    children: [
                      CDBBorderGradientButton(
                        ...
                        status: widget.accountEntity.nickName.isNotEmpty
                            ? ButtonStatus.ENABLE
                            : ButtonStatus.DISABLE,
                        onTap: (){
                          Navigator.pushNamedAndRemoveUntil(
                              context,
                              Routes.kAccountListView,
                              ModalRoute.withName(Routes.kQuickAccessMenu));
                        },
                        text: AppString.changeNickname.localize(context),
                      ),
