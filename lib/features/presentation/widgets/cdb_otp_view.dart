...
class CDBOtpView extends StatefulWidget {
  ...
  /// Colors of the input fields if the [CDBOtpView] is disabled. Default is [Colors.grey]
  ...
  @override
  _CDBOtpViewState createState() => _CDBOtpViewState();
}

class _CDBOtpViewState extends State<CDBOtpView> {
